...
def test_create_localization_data_object() -> None:
    localization_data = localization.LocalizationData(
        region_id=100, city_id=120, city_name="Warszawa"
    )
...
def test_localization_return_localization_data_success(localization_data) -> None:
    ...
    assert (
        expected_data
        == localization.Localization("Warszawa").return_localization_data()
    )


def test_localization_return_localization_data_fail(localization_data) -> None:
