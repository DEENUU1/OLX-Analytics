...
from base.data.parser import ParamsData, ParseData, Parser
from base.operation import operation


@pytest.fixture
def apartments_test_data() -> List[ParseData]:
...
@pytest.fixture
def houses_test_data() -> List[ParseData]:
...
def test_return_newest_offers_empty_list(apartments_test_data) -> None:
    assert operation.return_newest_offers(apartments_test_data) == []


def test_return_average_price_success(apartments_test_data) -> None:
    assert operation.return_average_price(apartments_test_data) == 189375.0


def test_return_average_price_zero_division_error() -> None:
    test_data = ParseData(
...
def test_return_average_price_per_meter_success(apartments_test_data) -> None:
    assert operation.return_average_price_per_meter(apartments_test_data) == 3591.57


def test_return_offer_largest_area_plot_returns_none(apartments_test_data) -> None:
    assert operation.return_offer_largest_area_plot(apartments_test_data) == None


def test_return_offer_largest_area_plot_success(houses_test_data) -> None:
    assert (
...
def test_return_offer_largest_area_building(apartments_test_data) -> None:
    assert (
...
def test_return_most_expensive_offer_per_meter(apartments_test_data) -> None:
    assert (
...
def test_return_most_expensive_offer(apartments_test_data) -> None:
    assert (
