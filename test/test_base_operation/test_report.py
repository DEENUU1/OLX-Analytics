from test.test_app_config import app, client, populated_database

from base.operation.report import Report, ReportApartment, ReportHouse
from web.models import ApartmentData


def test_return_weekly_average_price_apartment_data() -> None:
    data = [
...
def test_return_weekly_average_area_price_apartment_data() -> None:
    data = [
...
def test_return_report_apartment_data(populated_database) -> None:
...
def test_return_house_apartment_data(populated_database) -> None:
