...
class UrlBuilderApartment(UrlBuilder):
    ...
    def build_url(self, **kwargs) -> str:
        ...
        url += f"&filter_enum_builttype%5B0%5D={kwargs.get('build_type')}"
        url += f"&filter_enum_floor_select%5B0%5D=floor_{kwargs.get('floor_select')}"
        url += f"&filter_enum_furniture%5B0%5D={kwargs.get('furniture')}"
        url += f"&filter_enum_rooms%5B0%5D={kwargs.get('rooms')}"
        url += f"&filter_float_m%3Afrom={kwargs.get('area_min')}"
        url += f"&filter_float_m%3Afrom={kwargs.get('area_max')}"
        url += f"&filter_float_price%3Afrom={kwargs.get('price_min')}"
        url += f"&filter_float_price%3Ato={kwargs.get('price_max')}"
        # url += f"&region_id={kwargs.get('region_id')}"
        # url += f"&city_id={kwargs.get('city_id')}"
        return url
...
class UrlBuilderHouse(UrlBuilder):
    ...
    def build_url(self, **kwargs) -> str:
        ...
        url += f"&category_id={kwargs.get('category_id')}"
        url += f"&filter_enum_builttype%5B0%5D={kwargs.get('build_type')}"
        url += f"&filter_enum_market[0]=primary={kwargs.get('market_type')}"
        url += f"filter_enum_furniture%5B0%5D={kwargs.get('furniture')}"
        url += f"filter_enum_floor%5B0%5D={kwargs.get('floor_count')}"
        url += f"&filter_float_area%3Afrom={kwargs.get('area_min')}"
        url += f"&filter_float_area%3Ato={kwargs.get('area_max')}"
        url += f"&filter_float_m%3Ato={kwargs.get('plot_area_min')}"
        url += f"&filter_float_price%3Afrom={kwargs.get('plot_area_max')}"
        url += f"&filter_float_price_per_m%3Afrom={kwargs.get('price_per_m_min')}"
        url += f"&filter_float_price_per_m%3Ato={kwargs.get('price_per_m_max')}"
        url += f"&filter_float_price%3Afrom={kwargs.get('price_min')}"
        url += f"&filter_float_price%3Ato={kwargs.get('price_max')}"
        url += f"&region_id={kwargs.get('region_id')}"
        url += f"&city_id={kwargs.get('city_id')}"
